...
companyRoute.get(
    ...
    verifyUser,
    allowAccess('RECRUITER'),
    asyncWrapper(companyController.getCompanyView)
);

companyRoute.get('/states/:companyId', verifyUser, allowAccess('RECRUITER'), asyncWrapper(companyController.getStates));
